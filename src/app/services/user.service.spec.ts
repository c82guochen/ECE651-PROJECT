...
describe('UserService', () => {
  ...
  it('set value to user',() => {
    ...
    mockUser = {
        ...
        id: '', token: '',
        email: '', credit_card: '',
        shipping_address: '', last_login: new Date(),
        date_joined: new Date(),  expiry: new Date(),
        is_active: true,  is_staff: false,
        is_superuser: false, cart_items: [],
        orders: [], fav_recipes: [],
  ...
  it('get value of user',() => {
    let mockUser: BehaviorSubject<User|null> = new BehaviorSubject<User|null>({
        username: 'username',
        id: '', token: '',
        email: '', credit_card: '',
        shipping_address: '', last_login: new Date(),
  ...
  it('update account information', fakeAsync(() => {
     let user: User = {
       username: 'username',
       id: '', token: 'token',
       email: 'email@uwaterloo.ca', credit_card: '',
       shipping_address: '', last_login: new Date(),
       date_joined: new Date(),  expiry: new Date(),
       is_active: true,  is_staff: false,
       is_superuser: false, cart_items: [],
    ...
    service.UpdateUser(user,'1111222233334444','1112223333','address','province','N2L0E1',user.token)
    .subscribe((res) => {
      console.log(res);
